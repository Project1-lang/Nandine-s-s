              ...
              <Card className="project-card">
                ...
                <Card.Body>
                  ...
                  <Card.Text className="project-text">
                    ...
                    ullam alias corrupti laudantium cupiditate eveniet sunt
                    nobis, corporis fugit maiores quis similique debitis
                    nesciunt, veniam saepe consequuntur perferendis, suscipit
                    accusamus!.
                  </Card.Text>
